...
import { ArrowLeft, User, Mail, Phone, Award, Save } from "lucide-react";
      ...
      <div className="bg-gradient-to-r from-[#192a3e] via-[#243850] to-[#192a3e] text-white pt-12 md:pt-16 pb-24 px-6 md:px-12 rounded-b-[2.5rem] md:rounded-b-[4rem] shadow-xl relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-[24px] md:text-[28px] font-bold tracking-tight">Agregar Nuevo Doctor</h1>
              <p className="text-[14px] text-white/70">Registrar un nuevo profesional en la plataforma</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-[#192a3e]/60 ml-1 uppercase tracking-wider">Nombre Completo</label>
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#717182] group-focus-within:text-[#c1a16a] transition-colors" />
                  <input 
                    type="text" 
              ...
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-[#192a3e]/60 ml-1 uppercase tracking-wider">Especialidad</label>
                <div className="relative group">
                  <Award className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#717182] group-focus-within:text-[#c1a16a] transition-colors" />
                  <input 
                    type="text" 
              ...
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-[#192a3e]/60 ml-1 uppercase tracking-wider">Correo Electrónico</label>
                <div className="relative group">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#717182] group-focus-within:text-[#c1a16a] transition-colors" />
                  <input 
                    type="email" 
                    placeholder="doctor@althea.com"
                    className="w-full pl-12 pr-4 py-3.5 bg-[#f8f9fa] border border-[#e9ecef] rounded-2xl text-[15px] focus:outline-none focus:ring-2 focus:ring-[#c1a16a]/20 focus:border-[#c1a16a] transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-[#192a3e]/60 ml-1 uppercase tracking-wider">Teléfono</label>
                <div className="relative group">

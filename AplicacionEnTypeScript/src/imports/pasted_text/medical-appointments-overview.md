...
IEEE 830-1998 Software Requirements Specification	IEEE Recommended Practice For Software Requirements Speci~cations - IEEE Std 830-1998
Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP)	https://www.ordenjuridico.gob.mx/
Norma Oficial Mexicana NOM-004-SSA3-2012	NOM_004_SSA3_2012.pdf

1.6.- VISIÓN GENERAL DEL DOCUMENTO
El presente documento se encuentra organizado en diferentes secciones con el propósito de describir de manera clara y estructurada los requisitos del sistema de gestión de citas médicas y arrendamiento de consultorios.
En la primera sección se presenta la introducción al documento, donde se describe el propósito del sistema, el ámbito en el que se desarrollará, las definiciones y acrónimos utilizados, así como las referencias normativas y documentales que sirven como base para la elaboración de esta especificación.
La segunda sección describe de forma general el sistema, incluyendo su contexto, la perspectiva del producto, las funciones principales que ofrecerá, las características de los distintos tipos de usuarios que interactuarán con el sistema, así como las restricciones, suposiciones y dependencias relacionadas con su funcionamiento.
En las secciones posteriores se detallan los requisitos funcionales y no funcionales del sistema, los cuales especifican las funcionalidades que el sistema debe cumplir, así como las condiciones de calidad, seguridad y rendimiento necesarias para su correcto funcionamiento.
Asimismo, el documento puede incluir información adicional relacionada con el diseño del sistema, como casos de uso y otros elementos que permitan comprender mejor el comportamiento y la estructura del sistema.
La estructura de este documento sigue las recomendaciones establecidas en el estándar IEEE 830 especificaciones de requisitos de software, con el objetivo de garantizar una correcta documentación de los requisitos del software.
...
2.4.- RESTRICCIONES
•	El sistema debe cifrar las contraseñas de todos los usuarios. 
•	Se rige por los estándares de la norma NOM-004.
•	El sistema debe garantizar la confidencialidad de los expedientes clínicos. 
•	Todos los pagos e información deben realizarse con protocolos seguros. 
•	El sistema debe realizar copias de seguridad automáticas de la base de datos cada 24 horas para evitar la pérdida de historiales médicos. 
•	El sistema debe registrar un historial de movimientos para resolver aclaraciones o disputas de dinero.
•	Debe de tener un diseño funcional sencillo, con el que el usuario se sienta familiarizado en aproximadamente 1 minuto. 
•	El diseño debe seguir una estética moderna y limpia, que al realizar acciones no se requieran más de 15 toques. 
•	El sistema debe ser lo suficientemente estable para que el usuario final no requiera asistencia técnica externa para completar un flujo básico.
•	La aplicación debe ser compatible con los sistemas operativos Android y iOS.
•	El tiempo de carga de cada una de las pantallas de la aplicación debe ser menor a 2 segundos. 
•	El sistema debe soportar al menos 200 usuarios simultáneos en su primera versión. 
•	La confirmación de pago no debe tardar más de 10 segundos en procesarse.
•	El sistema debe estar documentado adecuadamente para facilitar el mantenimiento futuro. 
•	El sistema debe permitir actualizaciones sin afectar la integridad de los datos existentes.
2.5.- SUPOSICIONES Y DEPENDENCIAS
•	Los usuarios tendrán acceso a internet.
•	Los usuarios contaran con un dispositivo móvil actualizado.
•	Los doctores configurarán sus horarios.
•	El sistema dependerá de servicios externos de pago.
2.6.- REQUISITOS FUTUROS
•	Integración con seguros médicos.
•	Sistema de recordatorios para medicamentos o tratamientos.
III.- REQUISITOS ESPECÍFICOS
Requisitos funcionales
Número del Requisito:	RF01
Nombre del Requisito:	Registro y baja de doctores
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir que el administrador registre y de baja de doctores.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF02
Nombre del Requisito:	Registrar paciente
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir el registro de nuevos pacientes.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF03
Nombre del Requisito:	Actualizar datos de paciente
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir actualizar los datos del paciente.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF04
Nombre del Requisito:	Mostrar lista de pacientes
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir al doctor visualizar su lista de pacientes
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF05
Nombre del Requisito:	Agendar cita
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir agendar citas médicas dentro del horario establecido (8:00a.m.- 8:00p.m.).
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF06
Nombre del Requisito:	Cancelar cita
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir al doctor y paciente cancelar citas médicas.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF07
Nombre del Requisito:	Reprogramar cita
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir al paciente reprogramar citas médicas.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF08
Nombre del Requisito:	Bloquear horarios
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir a los doctores bloquear fechas u horas no disponibles para agendar.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF09
Nombre del Requisito:	Consultar agenda
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir al doctor consultar su agenda de citas.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF010
Nombre del Requisito:	Gestionar sucursales
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe gestionar múltiples sucursales.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional
...
Nombre del Requisito:	Validar disponibilidad
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe validar la disponibilidad del consultorio por fecha y hora.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF12
Nombre del Requisito:	Registrar en expediente
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir que el doctor registre información clínica en el expediente del paciente.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF13
Nombre del Requisito:	Consultar historial médico
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir al doctor consultar el historial médico del paciente.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF14
Nombre del Requisito:	Subir archivos a expediente
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir subir archivos relacionados con el expediente clínico.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF15
Nombre del Requisito:	Realizar pago
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir realizar pagos electrónicos dentro de la aplicación.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional




Número del Requisito:	RF16
Nombre del Requisito:	Cobrar anticipo
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe cobrar automáticamente el 50% de anticipo al agendar una cita.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF17
Nombre del Requisito:	Retener anticipo
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe retener el 50% del anticipo si la cancelación no cumple con el tiempo requerido.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF18
Nombre del Requisito:	Reembolsar anticipo
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe reembolsar automáticamente el anticipo si el doctor cancela la cita.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF19
Nombre del Requisito:	Dar de baja doctor
Tipo:	☒Requisito                  ☐Restricción
Descripción:	Cuando se da de baja un doctor, el sistema debe hacer que el historial de citas de este permanezca intacto, pero no se muestre en la interfaz.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF20
Nombre del Requisito:	Hacer comentario
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe contar con un apartado de retroalimentación donde los pacientes puedan hacer comentarios acerca de sus citas y doctores.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional



Número del Requisito:	RF21
Nombre del Requisito:	Autenticación
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir autenticación mediante usuario y contraseña, o bien, por medio de Facebook o Google.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF22
Nombre del Requisito:	Controlar acceso
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe controlar el acceso a funcionalidades e información según el rol del usuario.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF23
Nombre del Requisito:	Enviar notificaciones
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe enviar notificaciones sobre: confirmación de citas, cancelación de citas, reprogramación de citas.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RF24
Nombre del Requisito:	Visualizar métricas del sistema
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir al administrador visualizar el número de pacientes por doctor y las métricas de uso del sistema, permitiendo generar reportes de esto mismo.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☒Baja/Opcional

Requisitos NO Funcionales:
Número del Requisito:	RNF01
Nombre del Requisito:	Cifrado de contraseñas
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe cifrar las contraseñas de todos los usuarios antes de almacenarlas en la base de datos para garantizar la seguridad de la información.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional
Número del Requisito:	RNF02
Nombre del Requisito:	Cumplimiento de la norma NOM--004
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe cumplir con los lineamientos establecidos en la norma NOM-004 relacionados con el manejo de expedientes clínicos electrónicos.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF03
Nombre del Requisito:	Confidencialidad de expedientes clínicos
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe garantizar la confidencialidad y protección de los expedientes clínicos de los pacientes, permitiendo el acceso únicamente a usuarios autorizados.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF04
Nombre del Requisito:	Seguridad de pagos y datos
Tipo:	☒Requisito                  ☐Restricción
Descripción:	Todos los pagos y la transmisión de información sensible deben realizarse mediante protocolos de comunicación seguros.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF05
Nombre del Requisito:	Copias de seguridad automáticas
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe realizar copias de seguridad automáticas de la base de datos cada 24 horas para prevenir la pérdida de información médica.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional
...
Número del Requisito:	RNF06
Nombre del Requisito:	Registro de historial de movimientos 
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe registrar un historial de movimientos y transacciones para permitir auditorías, aclaraciones o resolución de disputas relacionadas con pagos o cambios en el sistema.
Prioridad del Requisito:	☒Alta/Esencial             ☒Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF07
Nombre del Requisito:	Diseño intuitivo de la interfaz
Tipo:	☒Requisito                  ☐Restricción
Descripción:	La interfaz del sistema debe tener un diseño sencillo y funcional que permita a los usuarios familiarizarse con su uso en aproximadamente un minuto.
Prioridad del Requisito:	☒Alta/Esencial             ☒Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF08
Nombre del Requisito:	Diseño Moderno y eficiente 
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El diseño debe seguir una estética moderna y limpia, que al realizar acciones no se requieran más de 10 toques.
Prioridad del Requisito:	☒Alta/Esencial             ☒Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF09
Nombre del Requisito:	Facilidad de uso del sistema
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe ser lo suficientemente estable e intuitivo para que los usuarios puedan completar los procesos principales sin requerir asistencia técnica externa.
Prioridad del Requisito:	☐Alta/Esencial             ☒Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF10
Nombre del Requisito:	Compatibilidad con dispositivos móviles
Tipo:	☒Requisito                  ☐Restricción
Descripción:	La aplicación debe ser compatible con los sistemas operativos Android y iOS.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF11
Nombre del Requisito:	Tiempo de carga entre pantallas
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El tiempo de carga de cada pantalla de la aplicación debe ser menor a 2 segundos bajo condiciones normales de operación.
Prioridad del Requisito:	☐Alta/Esencial             ☒Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF12
Nombre del Requisito:	Soporte de usuarios simultáneos
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe ser capaz de soportar al menos 200 usuarios simultáneos en su primera versión sin afectar su rendimiento.
Prioridad del Requisito:	☐Alta/Esencial             ☒Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF13
Nombre del Requisito:	Tiempo de confirmación de pago
Tipo:	☒Requisito                  ☐Restricción
Descripción:	La confirmación de pagos realizados en el sistema no debe tardar más de 10 segundos en procesarse.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF14
Nombre del Requisito:	Documentación del sistema
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe estar documentado adecuadamente para facilitar el mantenimiento futuro.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

Número del Requisito:	RNF15
Nombre del Requisito:	Actualizaciones seguras
Tipo:	☒Requisito                  ☐Restricción
Descripción:	El sistema debe permitir actualizaciones sin afectar la integridad de los datos existentes.
Prioridad del Requisito:	☒Alta/Esencial             ☐Media/Deseada             ☐Baja/Opcional

3.1.- REQUISITOS COMUNES DE LAS INTERFACES
3.1.1.- INTERFACES DE USUARIO
La interfaz de usuario se compone de una aplicación móvil que permitirá a los usuarios interactuar con el sistema de manera sencilla e intuitiva. La aplicación contará con diferentes pantallas como registro de usuario, inicio de sesión, agenda de citas, historial de citas, información del paciente y gestión de consultas médicas.
Además, la interfaz presentará botones, listas desplegables, calendarios para seleccionar fechas disponibles y campos de texto para el ingreso de información. El diseño de la aplicación deberá ser amigable, moderno y fácil de utilizar, permitiendo a los usuarios navegar por las diferentes funcionalidades del sistema de forma rápida y eficiente.
3.1.2.- INTERFACES DE HARDWARE
Será necesario disponer de dispositivos móviles en buen estado que permitan ejecutar la aplicación y cuenten con conexión a internet. Estos dispositivos deberán tener pantalla táctil, procesador adecuado, memoria suficiente y conectividad mediante WiFi o datos móviles.
3.1.3.- INTERFACES DE SOFTWARE
Sistema Operativo Android 8.0 o superior, iOS 13 o superior.
3.1.4.- INTERFACES DE COMUNICACIÓN
La comunicación entre la aplicación, los servidores y los servicios externos se realizará mediante protocolos estándar de internet, utilizando conexiones seguras para el intercambio de información. De igual manera el sistema podrá comunicarse con servicios externos para la gestión de pagos y el envío de notificaciones a los usuarios.
3.2.- REQUISITOS FUNCIONALES
3.2.1.- REGISTRO Y BAJA DE DOCTORES
El sistema debe permitir que el administrador realice el registro de nuevos profesionales en la plataforma, así como gestionar la salida de estos cuando sea necesario para mantener actualizada la plantilla del consultorio.
3.2.2.- REGISTRAR PACIENTE
El sistema debe permitir el registro de nuevos pacientes, capturando toda la información personal y de contacto necesaria para iniciar su seguimiento médico dentro de la aplicación.
3.2.3.- ACTUALIZAR DATOS DE PACIENTE
El sistema debe poseer un módulo dedicado a la edición y actualización de los datos personales o de contacto de los pacientes que ya se encuentran registrados previamente en el sistema.
3.2.4.- MOSTRAR LISTA DE PACIENTES
El sistema debe permitir al doctor visualizar de manera clara y organizada su lista completa de pacientes, facilitando el acceso a la información de las personas que tiene bajo su cargo.
3.2.5.- AGENDAR CITA
El sistema debe proporcionar la funcionalidad para agendar citas médicas, asegurando que estas se realicen estrictamente dentro del horario de operación establecido, que comprende de 8:00 a.m. a 8:00 p.m.
3.2.6.- CANCELAR CITA
El sistema debe permitir que tanto el doctor como el paciente realicen la cancelación de citas médicas previamente agendadas a través de los módulos correspondientes en la interfaz.
3.2.7.- REPROGRAMAR CITA
El sistema debe contar con un apartado que permita al paciente solicitar el cambio de fecha o de hora de una cita médica ya registrada, siempre que el nuevo horario cuente con disponibilidad.
3.2.8.- BLOQUEAR HORARIOS
El sistema debe permitir a los doctores bloquear fechas u horas específicas en las que no estarán disponibles para atender, evitando así que se agenden citas en esos lapsos de tiempo.
3.2.9.- CONSULTAR AGENDA
El sistema debe permitir al doctor realizar consultas de su agenda personalizada, mostrando de forma cronológica las citas confirmadas y el estado de sus horarios diarios.
3.2.10.- GESTIONAR SUCURSALES
El sistema debe tener un módulo para gestionar múltiples sucursales, permitiendo administrar la información de ubicación y la asignación de recursos para los tres consultorios disponibles en la casa.
3.2.11.- VALIDAR DISPONIBILIDAD
El sistema debe validar automáticamente la disponibilidad física del consultorio por fecha y hora antes de confirmar cualquier agendamiento, garantizando que no existan traslapes entre pacientes.
3.2.12.- REGISTRAR EN EXPEDIENTE
El sistema debe permitir que el doctor registre de forma segura toda la información clínica, diagnósticos y observaciones pertinentes directamente en el expediente electrónico del paciente.
3.2.13.- CONSULTAR HISTORIAL MÉDICO
El sistema debe proveer una funcionalidad que permita al doctor consultar el historial médico completo del paciente, facilitando la revisión de antecedentes y tratamientos previos antes de una consulta.
3.2.14.- SUBIR ARCHIVOS A EXPEDIENTE
El sistema debe permitir al personal autorizado subir y adjuntar archivos digitales relacionados con el expediente clínico, tales como resultados de laboratorio, recetas o imágenes de estudios médicos.
3.2.15.- REALIZAR PAGO
El sistema debe integrar una plataforma de pagos que permita a los pacientes liquidar el costo de sus servicios médicos de forma electrónica y segura directamente desde la aplicación.
3.2.16.- COBRAR ANTICIPO
Al momento de agendar una cita, el sistema debe realizar automáticamente el cobro de un anticipo equivalente al 50% del valor de la consulta para asegurar la reservación del espacio.
3.2.17.- RETENER ANTICIPO
El sistema debe implementar la lógica necesaria para retener el 50% del anticipo cobrado en caso de que el paciente cancele su cita fuera de los tiempos permitidos por las políticas de la empresa.
3.2.18.- REEMBOLSAR ANTICIPO
El sistema debe gestionar el reembolso automático del anticipo total al paciente en aquellas situaciones donde sea el doctor quien cancele la cita programada.
3.2.19.- DAR DE BAJA DOCTOR
Cuando se procesa la salida de un médico, el sistema debe asegurar que su historial de citas permanezca íntegro en la base de datos para fines administrativos, aunque su perfil ya no sea visible en la interfaz pública.
3.2.20.- HACER COMENTARIO
El sistema debe contar con un apartado de retroalimentación donde los pacientes tengan la posibilidad de dejar comentarios y opiniones sobre la atención recibida por parte de los doctores y el servicio del consultorio.
3.2.21.- AUTENTICACIÓN
El sistema debe permitir el acceso seguro de los usuarios mediante el uso de credenciales tradicionales (usuario y contraseña) o a través de la integración con cuentas de Facebook o Google.
3.2.22.- CONTROLAR ACCESO
El sistema debe controlar rigurosamente el acceso a las funcionalidades y a la información sensible, basándose en el rol asignado a cada usuario (Administrador, Doctor o Paciente).
3.2.23.- ENVIAR NOTIFICACIONES
El sistema debe ser capaz de enviar notificaciones automáticas sobre la confirmación de citas, cancelaciones o reprogramaciones para mantener informados tanto a médicos como a pacientes.
3.2.24.- VISUALIZAR MÉTRICAS DEL SISTEMA
El sistema debe permitir al administrador visualizar el número de pacientes atendidos por cada doctor y diversas métricas de uso, facilitando la generación de reportes detallados sobre el desempeño del consultorio.
3.3.- REQUISITOS NO FUNCIONALES
3.3.1.- REQUISITOS DE RENDIMIENTO
El sistema debe garantizar tiempos de respuesta rápidos durante la interacción del usuario con la aplicación. El tiempo de carga de cada una de las pantallas de la aplicación no debe superar los 2 segundos bajo condiciones normales de uso.
De igual manera, el sistema debe ser capaz de soportar al menos 200 usuarios simultáneos en su primera versión sin afectar el rendimiento general de la aplicación.
Adicionalmente, el sistema debe procesar la confirmación de pagos realizados por los usuarios en un tiempo máximo de 10 segundos.
3.3.2.- SEGURIDAD
El sistema debe garantizar la seguridad de la información almacenada dentro de la plataforma. Todas las contraseñas de los usuarios deberán almacenarse utilizando mecanismos de cifrado que protejan los datos ante accesos no autorizados.
Asimismo, el sistema debe garantizar la confidencialidad y protección de los expedientes clínicos de los pacientes, evitando accesos indebidos a esta información sensible.
Adicionalmente, todas las transacciones de pago y el intercambio de información dentro del sistema deberán realizarse mediante protocolos de comunicación seguros.
3.3.3.- FIABILIDAD
El sistema debe proporcionar una interfaz de usuario sencilla, funcional e intuitiva que permita a los usuarios familiarizarse con su funcionamiento en aproximadamente un minuto de uso.
Asimismo, el diseño de la aplicación debe seguir una estética moderna y limpia, permitiendo que los usuarios puedan realizar acciones dentro del sistema sin requerir más de 10 toques o interacciones para completar una tarea.
El sistema también debe ser lo suficientemente estable para que el usuario final pueda completar los procesos básicos sin requerir asistencia técnica externa.
3.3.4.- DISPONIBILIDAD 
El sistema debe estar disponible las 24 horas del día durante los 7 días de la semana, permitiendo a los usuarios acceder a la plataforma y realizar sus operaciones en cualquier momento.
3.3.5.- MANTENIBILIDAD
El sistema debe contar con documentación adecuada que facilite su mantenimiento, actualización y evolución futura.
Asimismo, el sistema debe permitir la realización de actualizaciones o mejoras sin comprometer la integridad de los datos existentes dentro de la aplicación.
3.3.6.- PORTABILIDAD
El sistema debe ser compatible con dispositivos móviles que utilicen los sistemas operativos Android e iOS, garantizando su correcto funcionamiento en ambas plataformas.
